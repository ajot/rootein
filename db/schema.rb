...
ActiveRecord::Schema[8.0].define(version: 2026_02_14_131954) do
  ...
  create_table "rooteins", force: :cascade do |t|
    ...
    t.boolean "remind_on_slack", default: false, null: false
    t.index ["user_id"], name: "index_rooteins_on_user_id"
  end
  ...
  add_foreign_key "rooteins", "users"
